; ModuleID = 'examples/sample/sample.bc'
source_filename = "examples/sample/sample.c"
...
define dso_local i32 @sample(i32 %x) #0 !dbg !7 {
entry:
...
entry:
  ...
  %call = call i32 @sample(i32 %1), !dbg !33
  ret i32 %call, !dbg !34
}
...
!1 = !DIFile(filename: "examples/sample/sample.c", directory: "/home/tareq/docker-all/klee-2.3")
!2 = !{}
!3 = !{i32 7, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"Ubuntu clang version 11.1.0-++20211011094159+1fdec59bffc1-1~exp1~20211011214614.8"}
!7 = distinct !DISubprogram(name: "sample", scope: !1, file: !1, line: 7, type: !8, scopeLine: 7, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!32 = !DILocation(line: 20, column: 17, scope: !25)
